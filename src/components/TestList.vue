        ...
        <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;">
          <Tabs v-model="selectedTestDetailTab" style="height: 390px;" @on-click="onDetailTabClicked">
            <TabPane label="raw content" name="content">
              <div style="word-break:break-all;padding-bottom:10px;overflow-y:auto;height:340px;" v-html="rawContent">
              </div>
            </TabPane>
            <TabPane label="ddl" name="ddl">
              ...
              <div>
                <div style="word-break:break-all;padding-bottom:10px;overflow-y:auto;height:270px;" v-html="parseToDDLResult.ddl">
                </div>
              </div>
            </TabPane>
          </Tabs>
