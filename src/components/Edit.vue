    ...
    <div class="test-detail">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:scroll;padding-bottom:10px;">
          <Tabs v-model="inboundReqModal.selectedTab" style="height: 390px;" @on-click="inboundReqTabClicked">
            <TabPane label="ddl" name="ddl">
              ...
              <Input v-model="inboundReqModal.ddl" type="textarea" placeholder="modify the request through DDL." class="inbound-req-edit-area" style="overflow:scroll;width: 100%;"></Input>
            </TabPane>
      ...
      <Modal v-model="outboundReqModal.show" width="1000">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:scroll;padding-bottom:10px;">
          ...
          <Input v-model="outboundReqModal.content" type="textarea" class="outbound-req-edit-area" placeholder="specify the content to match." style="overflow:scroll;width: 100%;margin-top:20px;"></Input>
        </div>
        <div slot="footer">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:scroll;padding-bottom:10px;">
          <Tabs v-model='outboundRespModal.selectedTab' style="height: 390px;" @on-click="outboundRespTabClicked">
            <TabPane label="ddl" name="ddl">
              ...
              <Input v-model="outboundRespModal.ddl" type="textarea" placeholder="modify the request through DDL." class="outbound-resp-edit-area" style="overflow:scroll;width: 100%;"></Input>
            </TabPane>
            <TabPane label="preview (bytes generated by ddl) " name="content">
