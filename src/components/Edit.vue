  ...
  <div class="main-panel">
    <div class="test-detail">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;">
          <Tabs v-model="inboundReqModal.selectedTab" style="height: 390px;" @on-click="inboundReqTabClicked">
            <TabPane label="ddl" name="ddl">
              ...
              <Input v-model="inboundReqModal.ddl" type="textarea" placeholder="modify the request through DDL." class="inbound-req-edit-area" style="overflow:auto;width: 100%;"></Input>
            </TabPane>
            <TabPane label="preview (bytes generated by ddl)" name="content">
              <div style="word-break:break-all;padding-bottom:10px;" v-html="inboundReqModal.content">
              </div>
            </TabPane>
            <TabPane label="origin bytes" name="origin_content">
              <div style="word-break:break-all;padding-bottom:10px;" v-html="inboundReqModal.originContent">
              </div>
            </TabPane>
          </Tabs>
        </div>
      ...
      <Modal v-model="inboundRespModal.show" width="1000">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;">
          <div style="word-break:break-all;padding-bottom:10px;" v-html="inboundRespModal.content">
          </div>
        </div>
        <div slot="footer">
      ...
      <Modal v-model="outboundReqModal.show" width="1000">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;">
          ...
          <Input v-model="outboundReqModal.content" type="textarea" class="outbound-req-edit-area" placeholder="specify the content to match." style="overflow:auto;width: 100%;margin-top:20px;"></Input>
        </div>
        <div slot="footer">
        ...
        <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;">
          <Tabs v-model='outboundRespModal.selectedTab' style="height: 390px;" @on-click="outboundRespTabClicked">
            <TabPane label="ddl" name="ddl">
              ...
              <Input v-model="outboundRespModal.ddl" type="textarea" placeholder="modify the request through DDL." class="outbound-resp-edit-area" style="overflow:auto;width: 100%;"></Input>
            </TabPane>
            <TabPane label="preview (bytes generated by ddl) " name="content">
              <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;" v-html="outboundRespModal.content">
              </div>
            </TabPane>
            <TabPane label="origin bytes" name="origin_content">
              <div style="height:400px;word-break:break-all;overflow-y:auto;padding-bottom:10px;" v-html="outboundRespModal.originContent">
              </div>
            </TabPane>
          </Tabs>
        </div>
...
.inbound-req-edit-area .ivu-input{
  height:260px;
}
.outbound-req-edit-area .ivu-input{
  height:350px;
}
.outbound-resp-edit-area .ivu-input{
  height:260px;
}
</style>
